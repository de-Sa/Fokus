const botãoAdicionarTarefa = document.querySelector(".app__button--add-task");
const botãoCancelarTarefa = document.querySelector(
...
botãoCancelarTarefa.addEventListener("click", cancelarFormulario);
